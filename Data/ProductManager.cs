        ...
        public static List<Product> GetAllProducts()
        {
            if (Products == null || !Products.Any())
            {
                Products = new List<Product>() {
                    ...
                    new Product() { Name = "Coconut", Price = 2.40, Vat = 6, UnitsInStock = 1, Description = "A Coconut from Africa", LongDescription = "A very rare and exclusive african coconut with many uses including but not limited to: Drink Ingredient, Drink Container, Instrument of Death, Sound Effects tool, Rudimentary football, Exercise tool and more! As Enjoyed by the famous English King from legends"},
                    new Product() { Name = "StraitJacket", Price = 942.40, Vat = 12, UnitsInStock = 17, Description = "A very long sleeved shirt", LongDescription = "A very popular outfit at special parties, High quality cotton with leather straps. Very comfortable and with many settings and fixtures. CEOs favorite! One Size Restricts all!"},
                    new Product() { Name = "Hawaii Shirt", Price = 32.40, Vat = 25, UnitsInStock = 144, Description = "Shirt with classic motif", LongDescription = "Classy gentleman shirt with high quality leafy pattern, non-iron, non-shrink, non-wash model with factory shrinkles and smell of quality Rhum"},
                    new Product() { Name = "Crocs", Price = 102.40, Vat = 12, UnitsInStock = 56, Description = "Footwear for all occasions", LongDescription = "A classic unisex footwear suitable for all ages. Choking hazard"},
                    new Product() { Name = "Straw Hat", Price = 12.40, Vat = 12, UnitsInStock = 19, Description = "Comfortable summer hat", LongDescription = "Meticously handcrafted from organic high quality straw from Järna. Gives the wearer an aura of professionalism. Also suitable for scarecrows"},
                };
            }
